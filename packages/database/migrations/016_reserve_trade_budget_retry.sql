-- =============================================================================
-- RAPTOR v3.3 Migration 016: Allow retryable auto jobs to reuse executions
--
-- Issue: reserve_trade_budget blocks retries when an execution is FAILED.
--        Trade jobs can re-queue, but the reservation is rejected as
--        "Already executed" on the next attempt.
--
-- Fix: Add p_allow_retry to reuse FAILED executions for retryable jobs.
-- =============================================================================
